...
public partial class Mvc8DbProContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Courses__3214EC07008B5F55");
            ...
            entity.HasMany(d => d.Students).WithMany(p => p.Courses)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("CourseId", "StudentId").HasName("PK__tmp_ms_x__4A01231EF4F68B0D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Students__3214EC076D285A95");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Teachers__3214EC07531C388F");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Users__3214EC07D7BC6791");
